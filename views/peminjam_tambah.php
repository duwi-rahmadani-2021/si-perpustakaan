        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading" style="background-color:#06124a">
                    <h3 class="panel-title">Form Tambah Data Peminjaman Buku</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                         ...
                         <div class="form-group">
                            <label for="tgl_peminjaman" class="col-sm-3 control-label">Tanggal Peminjam</label>
                            <div class="col-sm-9">
                                <input type="date" name="tgl_peminjaman" class="form-control" id="inputEmail3" placeholder="Inputkan Tanggal Peminjam" required>
                            </div>
                        </div>
                         <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success" style="background-color:#06124a">
...
if($_POST){
  ...
  $judul_buku=$_POST['judul_buku'];
    ...
    //buat sql
    $sql="INSERT INTO tb_peminjaman VALUES ('','$nama','$no_buku','$tgl_peminjaman','$judul_buku','$pengarang')";
